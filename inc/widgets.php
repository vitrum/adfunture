...
function roots_widgets_init() {
  ...
  register_sidebar(array(
    'name' => __('Header Top Sidebar', 'roots'),
  ...
  register_sidebar(array(
    'name' => __('Header banner Sidebar', 'roots'),
    'id' => 'header-banner-sidebar',
    'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
  ...
  register_sidebar(array(
    'name' => __('Header logo Sidebar', 'roots'),
    'id' => 'header-logo-sidebar',
    'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
  ...
  register_sidebar(array(
    'name' => __('Top tools Sidebar', 'roots'),
    'id' => 'top-tools-sidebar',
    'before_widget' => '<section id="%1$s" class="widget %2$s"><div class="widget-inner">',
    'after_widget' => '</div></section>',
    'before_title' => '<h3>',
    'after_title' => '</h3>',
